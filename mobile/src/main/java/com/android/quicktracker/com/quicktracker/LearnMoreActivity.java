...
public class LearnMoreActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GestureDetector mGestureDetector = new android.view.GestureDetector(LearnMoreActivity.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onTouchDrawer(final int position) {
        ...
        switch (lastMenu = position) {
            case JOB_DETAILS_POSITION:
                Intent intent0 = new Intent(LearnMoreActivity.this, JobDetailsActivity.class);
                startActivity(intent0);
                break;
            case CALENDAR_POSITION:
                Intent intent = new Intent(LearnMoreActivity.this, CalendarActivity.class);
                startActivity(intent);
                break;
            case SETTINGS_POSITION:
                Intent intent2 = new Intent(LearnMoreActivity.this, SettingsActivity.class);
